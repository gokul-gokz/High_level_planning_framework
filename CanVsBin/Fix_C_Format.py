            ...
            for key in trials.keys():
                ...
                for sample in records:
                    ...
                    if B_made is False:
                        ...
                        new_records.append(tuple(new_sample))f
                    allC.append(tuple(new_sample))
                    if file.endswith('1_C.p'):
                        norm_C.append(tuple(new_sample))
                    elif file.endswith('2_C.p'):
                        fast_C.append(tuple(new_sample))
                    elif file.endswith('3_C.p'):
                        acc_C.append(tuple(new_sample))
                    if B_made is False:
